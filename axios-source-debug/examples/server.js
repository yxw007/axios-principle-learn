...
server = http.createServer(function (req, res) {
  ...
  if (/axios\.amd\.js$/.test(url)) {
    pipeFileToResponse(res, '../dist/axios.amd.js', 'text/javascript');
    return;
  }
  if (/axios\.amd\.map$/.test(url)) {
    pipeFileToResponse(res, '../dist/axios.amd.map', 'text/javascript');
    return;
  }
